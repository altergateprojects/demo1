-- ============================================================================
-- ADD MISSING PROMOTION FUNCTION ONLY
-- ============================================================================
-- This adds only the get_students_for_promotion function that's returning 404
-- ============================================================================
...
BEGIN
  ...
  ELSE
    ...
    IF v_function_result > 0 THEN
      ...
      RAISE NOTICE '========================================';
    ELSE
      RAISE NOTICE '⚠ Function returns 0 students - check if students have required columns';
    END IF;
  END IF;
END $$;
