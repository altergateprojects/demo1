-- Fix Student Exit with Dues Function
-- This creates/fixes the function to move students to the dues section

-- First, ensure the student_exit_dues table exists
...
COMMENT ON FUNCTION record_student_exit_with_dues IS 'Moves a student to the dues section with complete financial snapshot';
COMMENT ON TABLE student_exit_dues IS 'Students who have exited with outstanding dues for debt collection';